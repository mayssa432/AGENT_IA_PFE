...
public class PopUpMessagesSteps {
    ...
    public void lePopUpMessageDeChangementDeCompteEstAffiche() {
        ...
        // Action : Vérifier que le titre du pop-up message de changement de compte est "Changement de compte"
        Assert.assertTrue(popUpMessagesPage.isChangeAccountPopupDisplayed());
    }
}