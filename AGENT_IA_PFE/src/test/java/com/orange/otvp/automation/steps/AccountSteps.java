...
public class AccountSteps {
    ...
    public void queLUtilisateurEstConnecteASonCompte() {
    ...
    public void leSystèmeAfficheLesDétailsDesOffresYComprisLesInformationsDeServiceEtLesOffres() {
        // Commentaire : Implémentation de la vérification des détails des offres
        // Action : Appel de la méthode pour vérifier les détails des offres
        Assert.assertTrue(accountPage.isOffersDetailsDisplayed());
    }
}