...
public class NavigationSteps {
    ...
    public void jeCliqueSurLeBoutonDecouverteDeLApplication() {
        navigationPage.clickOnDecouverteDeLApplicationButton();
    }

    @Then("je devrais être redirigé vers la page de découverte de l'application")
    public void jeDevraisEtreRedirigeVersLaPageDeDecouverteDeLApplication() {
        Assert.assertTrue(navigationPage.isDecouverteDeLApplicationPage());
    }
}
